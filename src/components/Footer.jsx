...
const Footer = () => {
  ...
  return (
    <footer className="py-12 px-6 border-t border-cyber-accent/10 relative overflow-hidden bg-white">
      {/* Neon divider glow */}
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 z-10 relative text-left">
        ...
        <div className="flex flex-col gap-2 text-center md:text-left">
          ...
          >
            AKASH<span className="text-gray-900 text-xs">.R</span>
          </a>
          <p className="font-inter text-[11px] text-gray-600 tracking-wider">
            &copy; {currentYear} AKASH R. ALL RIGHTS RESERVED. SECURED VIA CORE PROTOCOL.
          </p>
        </div>

        {/* Center Credits */}
        <div className="font-orbitron text-xs tracking-widest text-gray-600 text-center uppercase">
        ...
        <div className="flex gap-4">
          <a
            ...
            className="text-gray-600 hover:text-cyber-accent transition-colors"
            title="GitHub"
          >
            <FiGithub size={16} />
          </a>
